...
func init() {
	RegisterRoutes([]apiRoute{
		...
		{Method: "POST", Path: "/v1/files/{key}/presign", Summary: "Generate presigned URL", Tag: "files", Status: 200},
		...
		{Method: "POST", Path: "/v1/chat", Summary: "Chat with RAG", Tag: "chat", Body: `{"messages":[{"role":"user","content":"summarize"}]}`, Status: 200, Response: `{"answer":"summary text","model":"gpt-4o-mini","citations":[]}`},
		{Method: "POST", Path: "/v1/chat/stream", Summary: "Streaming chat", Tag: "chat", Body: `{"messages":[{"role":"user","content":"tell me a story"}]}`, Status: 200},
		{Method: "POST", Path: "/v1/agent", Summary: "Autonomous agent", Tag: "agent", Body: `{"task":"find and summarize"}`, Status: 200, Response: `{"answer":"result","model":"gpt-4o-mini","steps":[]}`},
		{Method: "GET", Path: "/v1/lineage/objects/{id}", Summary: "Object AI lineage", Tag: "search", Status: 200, Response: `{"usage":[{"request":"query","cost_micros":100}]}`},
		...
		{Method: "GET", Path: "/v1/buckets/{bucket}/versions", Summary: "List bucket versions", Tag: "buckets", Status: 200},
		...
		// Admin
		{Method: "GET", Path: "/v1/admin/config", Summary: "Get server config", Tag: "admin", Status: 200, Response: `{"version":"0.9.0"}`},
		{Method: "GET", Path: "/v1/admin/keys", Summary: "List API keys", Tag: "admin", AdminOnly: true, Status: 200},
		{Method: "POST", Path: "/v1/admin/keys", Summary: "Add API key", Tag: "admin", AdminOnly: true, Status: 200},
		...
		{Method: "POST", Path: "/v1/admin/tenants", Summary: "Create tenant", Tag: "admin", AdminOnly: true, Status: 200},
