-- Widen the terminal status without changing the existing billing row shape.
-- SQLite requires a table rebuild to alter an inline CHECK constraint.
...
INSERT INTO billing_usage_outbox_new
