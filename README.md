...
Iris UI npm packages, and includes object/access workflows plus an operator-only
job, tenant, and webhook operations view. It builds into the Go embedded assets:
